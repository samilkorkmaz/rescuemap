...
public class MySettings {
    ...
    private static final float CHILD_7_YEARS_OLD_DEFAULT_SPEED_MPS = 1000f;
    private static final float CHILD_15_YEARS_OLD_DEFAULT_SPEED_MPS = 2000f;
    private static final float ADULT_30_YEARS_OLD_DEFAULT_SPEED_MPS = 3000f;
